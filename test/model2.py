"""
Quantum LSTM classifier built with PennyLane.
This script mirrors the original BiLSTM workflow but swaps the recurrent core
with a quantum-enhanced LSTM cell.
"""
...
def vqc_block(n_qubits: int):
    """Create a variational quantum circuit as a TorchLayer."""
...
class QuantumGate(nn.Module):
    """Gate used to construct the quantum-enhanced LSTM gates."""
...
def parse_args():
    ...
    parser.add_argument("--train-size", type=int, default=1000, help="Number of training samples to use (0 for full)")
    parser.add_argument("--test-size", type=int, default=200, help="Number of test samples to use (0 for full)")
